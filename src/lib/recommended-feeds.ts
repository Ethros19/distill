export const recommendedFeeds: Array<{ name: string; url: string; category: string }> = [
  ...
  // Piper Dev — Event Industry Business Intelligence
  { name: 'MeetingsNet', url: 'https://www.meetingsnet.com/rss.xml', category: 'Piper Dev' },
  { name: 'Eventbrite Blog', url: 'https://www.eventbrite.com/blog/feed/', category: 'Piper Dev' },
]
