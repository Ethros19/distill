...
export const STREAM_VALUES = ['general-ai', 'piper-dev', 'event-tech', 'event-general', 'vc-investment', 'product'] as const
...
export const STREAM_BORDER_COLORS: Record<string, string> = {
  ...
  'piper-dev': 'border-t-emerald-500',
...
export const STREAM_DESCRIPTIONS: Record<Stream, string> = {
  ...
  'piper-dev': 'AI applications in event planning, vertical SaaS intelligence',
